...
//
// Two plain buttons rather than the modal Host Detail/Digest use: those
// offer a scoping choice (this host vs. filters) and a PDF page snapshot,
// none of which applies to a flat table. Here the scope is simply "what's
// on screen right now", so a modal would just add a click.
//
